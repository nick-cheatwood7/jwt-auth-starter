...
export type UsersQuery = { __typename?: 'Query', users: Array<{ __typename?: 'User', id: string, email: string, createdAt: number, updatedAt?: number | null, lastLogin?: number | null }> };
